...
export default function BusinessDetailsStep3() {
  ...
  const handleBackButton = () => {
    navigate("/business-details-2?quoteId=" + quoteId);
  };
                    ...
                    <div className="flex flex-col space-y-3 md:flex-row md:justify-between md:space-y-0 md:space-x-4 xl:px-9 my-10 text-grayCustom">
                      <div className="md:w-[512px] xl:max-w-3xl">
                        ...
                        <span className="align-middle">
                          <QuestionTooltip tooltipContent="If you can't provide your existing business insurance policy number, don't worry, you may leave this blank and we'll find it for you." />
                        </span>
                      </div>
                         ...
                         py-[10px]
                          ...
                          "
                            >
                              ...
                              <span className="text-grayCustom">+91</span>
                            </span>
                            <input
                              type="tel"
                              inputMode="numeric"
...
export async function action({ request }: ActionFunctionArgs) {
  ...
  try {
    ...
    return redirect("/verify-email?quoteId=new-quote", {
      headers: { "Set-Cookie": await commitSession(session) },
    });
  } catch (error) {
    console.error(error);
