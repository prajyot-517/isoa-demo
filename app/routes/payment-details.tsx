      ...
      <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
        <div className="bg-white rounded-lg shadow-md p-6 w-full max-w-md text-center">
          ...
          <p className="text-gray-600 mb-4">Your insurance is now covered.</p>
           <p className="text-gray-600 mb-4">We'll send you an email with policy documents.</p>
          <button
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
      <div className="bg-white rounded-lg shadow-md p-6 w-full max-w-md">
        <h1 className="text-xl font-semibold text-gray-800 mb-1">Payment Checkout</h1>
        ...
        <h2 className="text-lg font-medium text-gray-800 mb-4">Credit Card Payment</h2>
